...
class TfPublisher(adapters.ROSPublisherTF):
    ...
    def initialize(self):
        adapters.ROSPublisherTF.initialize(self)
        # store the frame ids
        self.frame_id = self.kwargs.get("frame_id", TfPublisher.default_frame_id)
        self.child_frame_id = self.kwargs.get("child_frame_id", TfPublisher.default_child_frame_id)
